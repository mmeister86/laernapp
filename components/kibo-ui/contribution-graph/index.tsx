...
const DEFAULT_LABELS: Labels = {
  ...
  totalCount: "{{count}} Aufgaben in {{year}}",
  legend: {
    less: "Weniger",
    more: "Mehr",
  },
...
export const ContributionGraph = ({
  ...
  const width = weeks.length * (blockSize + blockMargin) - blockMargin + 8;
  const height = labelHeight + (blockSize + blockMargin) * 7 - blockMargin + 8;
...
export const ContributionGraphBlock = ({
  ...
  return (
    <rect
      className={cn(
        "stroke-[2px] stroke-black transition-all duration-100",
        'data-[level="0"]:fill-gray-50',
        'data-[level="1"]:fill-[#0CBCD7]',
        'data-[level="2"]:fill-[#00D9BE]',
        'data-[level="3"]:fill-[#FFC667]',
        'data-[level="4"]:fill-[#FB7DA8]',
        "hover:stroke-[3px] hover:opacity-90 cursor-pointer",
        className
      )}
      ...
      ry={blockRadius}
      width={blockSize}
      x={(blockSize + blockMargin) * weekIndex + 4}
  ...
  return (
    ...
    >
      <svg
        ...
        width={width}
      >
        <title>Lernaktivität</title>
        {!hideMonthLabels && (
          <g className="fill-black font-extrabold">
...
export const ContributionGraphTotalCount = ({
  ...
  return (
    <div
      className={cn("text-black font-medium text-base", className)}
      {...props}
    >
      {labels.totalCount
        ? labels.totalCount
...
export const ContributionGraphLegend = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="mr-2 text-black font-medium text-sm">
        {labels.legend?.less || "Weniger"}
      </span>
      {new Array(maxLevel + 1).fill(undefined).map((_, level) =>
        children ? (
          ...
          <svg height={blockSize} key={level} width={blockSize}>
            <title>{`${level} Aufgaben`}</title>
            <rect
              className={cn(
                "stroke-[2px] stroke-black",
                'data-[level="0"]:fill-gray-50',
                'data-[level="1"]:fill-[#0CBCD7]',
                'data-[level="2"]:fill-[#00D9BE]',
                'data-[level="3"]:fill-[#FFC667]',
